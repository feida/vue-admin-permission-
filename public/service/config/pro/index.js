...
module.exports = {
    mysql: {    //线上只读数据库
        resto_brand: {
            host: 'rds64fw2qrd8q0eg95nmo.mysql.rds.aliyuncs.com',
            port: 3306,
            username: 'resto',
            password: 'Canjia2017',
    ...
    mqtt: {
        newpos: {
            ...
            subscribeTheme:`$queue/node_server/+/+/+/+/+`,
            options:{
                username:`admin`,
                password:`password`,
                clientId:`posAdmin-pro`,
                keepalive: 50,    // 设置会话心跳时间 60秒，设置0为禁用
                reconnectPeriod: 15 * 1000,    //1000毫秒，两次重新连接之间的间隔
                resubscribe:true,   //如果连接断开并重新连接，则会再次自动订阅已订阅的主题（默认true）
            }
        },
        api:{
            url:`http://emq.restoplus.cn/`,
